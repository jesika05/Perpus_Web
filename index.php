...
<html lang="en">
  <head>
    ...
    <title>JessiePerpustakaan</title>
    <link rel="icon" href="assets/per2.jpg" type="image/png">
  </head>
  <body>
    <!--Navbar-->
   <nav class="navbar fixed-top navbar-expand-lg bg-body-tertiary shadow-sm justify-space-between">
  <div class="container-fluid">
    <img src="assets/per1.jpg" alt="logo" width="120px">
    ...
    <section id="homeSection" class="p-5">
      <div class="d-flex flex-wrap justify-content-center">
        <div class="col mt-5">
         <h2 class="fw-bold text-success"><span class="text-primary">Jessie</span>Perpustakaan</h2>
          <p class="mb-4">"Temukan Dunia Pengetahuan di Ujung Jari Anda: <br> Perpustakaan Online <span class="fw-bold">JessiePerpustakaan</span> Membawa Anda ke Dunia Buku Digital."</p>
    ...
    <section class="bg-body-secondary p-5" id="aboutSection">
      ...
      <div class="d-flex justify-content-center">
        <h3 class="text-secondary">Dikelola Oleh :</h3>
      </div>

    <div class="d-flex justify-content-center flex-wrap gap-4 mt-4">
      <div class="card border-info mb-3" style="max-width: 18rem;">
        <div class="card-header">Jesika Octavia Hutagaol</div>
        <div class="card-body">
          <h5 class="card-title">JESSIEE PERPUSTAKAAN</h5>
        </div>
      </div>
    </div>
    </section>
    ...
    <footer id="footer" class="p-3 bg-dark">
      <div class="row">
        <div class="col">
          <img src="assets/per2.jpg" width="200px">
        </div>
      </div>
      <div class="row p-3">
        <div class="col mt-3">
          <h3 class="text-light fs-5">Alamat</h3>
          <p class="text-secondary fs-6">JL Hangtua Medan</p>
        </div>
        ...
        <div class="d-flex justify-content-center align-items-center mt-3">
          <p class="text-light"><a href="" class="text-decoration-none">JessiePerpustakaan</a>  2020</p>
        </div>
      </div>
    </footer>
