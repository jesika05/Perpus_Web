...
<html lang="en">
  ...
  <body>
    ...
    <div class="mt-5 p-4">
      ...
      <div class="alert alert-success" role="alert">Selamat datang admin - <span class="fw-bold text-capitalize"><?php echo $_SESSION['admin']['nama_admin']; ?></span> di Dashboard JessiePerpustakaan</div>
    ...
    <footer class="mt-5 shadow-lg bg-subtle p-3">
      ...
      <p class="mt-2"><span class="text-primary"> </span></p>
      <p class="mt-2"></p>
      </div>
    </footer>
